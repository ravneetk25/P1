...
const Home: React.FC = () => {
  return <div className="bg-[#0A0A12] text-white">
      {/* Hero Section */}
      <Hero title="Rady To Secure Your Startup In Minutes ?" subtitle="Protect your endpoints, networks, and cloud with AI-powered defense built for speed, scale, and compliance." primaryButtonText="Get Started" secondaryButtonText="Request Demo" image="src\pages\home.jpg" imageAlt="Cybersecurity dashboard visualization" />
