...
const AboutUs: React.FC = () => {
  return <div className="bg-[#0A0A12] text-white">
      {/* Hero Section */}
      <Hero title="Empowering startups with enterprise-grade security." subtitle="We're on a mission to make advanced cybersecurity accessible, affordable, and easy to implement for growing companies." image="src\pages\about.jpeg" backgroundPattern={true} />
      {/* Mission Section */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card hover className="p-6">
              <div className="text-center">
                <div className="w-32 h-32 rounded-full overflow-hidden mx-auto mb-4 relative">
                  ...
                  <img src="src\pages\ceo.jpeg" alt="CEO" className="w-full h-full object-cover" />
                </div>
            ...
            <Card hover className="p-6">
              <div className="text-center">
                <div className="w-32 h-32 rounded-full overflow-hidden mx-auto mb-4 relative">
                  <div className="absolute inset-0 bg-gradient-to-r from-[#29A8FF]/20 to-[#6C63FF]/20 rounded-full"></div>
                  <img src="src\pages\cto.jpeg" alt="CTO" className="w-full h-full object-cover" />
                </div>
                <h3 className="text-xl font-bold font-montserrat mb-1">
                  Praveen Gupta
                </h3>
            ...
            <Card hover className="p-6">
              <div className="text-center">
                <div className="w-32 h-32 rounded-full overflow-hidden mx-auto mb-4 relative">
                  <div className="absolute inset-0 bg-gradient-to-r from-[#29A8FF]/20 to-[#6C63FF]/20 rounded-full"></div>
                  <img src="src\pages\senior.jpeg" alt="CSO" className="w-full h-full object-cover" />
                </div>
                <h3 className="text-xl font-bold font-montserrat mb-1">
                  Minhaj Uddin
                </h3>
